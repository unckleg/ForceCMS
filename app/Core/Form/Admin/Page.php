...
class Page extends Zend_Form
{
    ...
    public function init() 
    {
        ...
        $titleAdd
             ...
             ->setAttribs(['class' => 'form-control', 'placeholder' => 'Insert title of your page', 'required' => ''])
             ->setRequired(true);
        ...
        $seoTitle
             ->addFilter('StringTrim')
             ->addValidator('StringLength', false, ['min' => 3, 'max' => 255])
             ->setAttribs(['class' => 'form-control input-sm', 'placeholder' => 'Insert seo title',])
             ->setRequired(false);
        ...
        $seoKeywords
             ...
             ->setAttribs(['class' => 'form-control input-sm', 'placeholder' => 'Insert seo description',])
             ->setRequired(false);
        ...
        $seoDescription
             ->addFilter('StringTrim')
             ->addValidator('StringLength', false, ['min' => 3, 'max' => 500])
             ->setAttribs(['class' => 'form-control input-sm', 'placeholder' => 'Insert seo keywords',])
             ->setRequired(false);
        ...
        $pagePhoto->addValidator('Count', true, 1)
                ...
                ->setRequired(false);
        $pagePhoto->getTransferAdapter()->setOptions(['useByteString' => false]);
        $pagePhoto->addFilter('Rename', ['target' => APP_PUBLIC . '/uploads/pages/'.date("Y-m-d-H-i-s") . '-' . $keywords . '.jpg', 'overwrite' => true]);
